    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="fixed bottom-4 right-4 z-[100] bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-4 w-full max-w-sm"
          role="alert"
        >
