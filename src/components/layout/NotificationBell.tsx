...
export function NotificationBell({ className }: { className?: string }) {
  ...
  return (
    <div className={cn('relative', className)} ref={ref}>
      ...
      {open && (
        <div className="fixed sm:absolute inset-x-0 sm:inset-x-auto sm:right-0 top-14 sm:top-[calc(100%+8px)] sm:w-[380px] mx-2 sm:mx-0 max-h-[70vh] overflow-y-auto rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-2xl z-50 p-4">
